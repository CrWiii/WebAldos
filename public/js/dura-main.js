duraFunc=function(){
	"use strict";$(window).scroll(function(){
		$(window).scrollTop()>=30?(
			...
			$(".scrollup").fadeOut()}),$(".scrollup").on("click",function(){
				return $("html, body").animate({scrollTop:0},600),!1}),
			$(".dura-search").on("click",function(){
				$(".overlay").addClass("overlay-visible")}),
			$(document).mouseup(function(a){var n=
				$(".dura-search");n.is(a.target)||0!==n.has(a.target).length||
				$(".overlay").removeClass("overlay-visible")}),
			$("#loginTab").on("click",function(a){a.preventDefault(),
				$(this).tab("show")}),
			$('.dropdown-menu a[data-toggle="tab"]').on("click",function(a){a.stopPropagation(),
				$(this).tab("show")}),
			...
			$(".carousel").carousel({interval:3e3})},duraFunc();