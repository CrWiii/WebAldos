                        ...
                        <div class="white-box">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form class="form-horizontal" role="form" method="POST" action="/ActualizarPregunta/{{$Question->id}}" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        <div class="form-group">
                                            <label class="col-md-2 control-label input-sm">Pregunta:</label>
                                            <div class="col-md-10">
                                                <input type="text" id="question" name="question" class="form-control input-sm" placeholder="" value="{{$Question->question}}"></div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-md-2 control-label input-sm">Respuesta:</label>
                                            <div class="col-md-10">
                                                <textarea class="form-control input-sm" rows="5" id="answer" name="answer">{{$Question->answer}}</textarea>
                                            </div>
                                        </div>
                                         <div class="form-group">
