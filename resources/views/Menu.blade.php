                  ...
                  <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1" aria-expanded="false" style="height: 1px;">
                    ...
                    @if($TypeN->slug!='colectivo_de_novios')
                       <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                              <ul>
                              <span><img src="{{url('img/anillo.png')}}" alt="product 1" class="img-responsive img-hi"></span>
                                <li style="text-align: center;"><a href="{{url('Novios',array('Type'=>$TypeN->slug))}}"><h3>{{$TypeN->description}}</h3></a></li>
                              </ul>
                            </div>
                    @endif
                    @endforeach
                        ...
                        <div class="dropdown-menu dropdown-mega-content">
                          <div class="row" style="padding: 20px; padding-bottom: 0">
                            ...
                            @foreach($TypesJoyas as $TypeJ)
                              ...
                              <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                <ul>
                                  <li style="text-align: center;"><a href="{{url('Joyeria',array('Type'=>$TypeJ->slug))}}"><span><img src="{{url('img/anillo.png')}}" class="img-responsive img-hi" alt="product 1" style="margin: auto;"><h3>{{$TypeJ->description}}</h3></a></li>
                                </ul>
                              </div>
                              @endif
                              <?php $f++;?>
